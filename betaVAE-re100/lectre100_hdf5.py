...
# Ouvre le fichier
with h5py.File('Re100alpha10_newData_150000.hdf5', 'r') as f:
    explorer(f)
...
plt.xlabel("x")
plt.ylabel("y")
plt.savefig("uvtf.jpg")

norm = np.sqrt(u**2 + v**2)
plt.imshow(norm, cmap='inferno')
plt.colorbar(label="||v||")
plt.title(f"Norme de la vitesse à t={t}")
plt.savefig("normtf.jpg")"""
...
#Vorticité w
def vorticity_2d(u, v, dx=1.0, dy=1.0):
    """
...
print("Images de vorticité sauvegardées dans frames_vort/")
