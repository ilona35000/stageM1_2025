...
parser.add_argument('-re',default=100,     type=int,   help="40 OR 100, Choose corresponding Reynolds number for the case")
parser.add_argument('-m', default="test", type=str,   help='Switch the mode between train, infer and run')
#parser.add_argument('-m', default="run", type=str,   help='Switch the mode between train, infer and run')
...
if __name__ == "__main__":
    ...
    if args.re==40:
        ...
        datafile = "/scratch/nautilus/projects/CEFIPRA/ilona/betaVAE-re100/Re100alpha10_newData_150000.hdf5"
